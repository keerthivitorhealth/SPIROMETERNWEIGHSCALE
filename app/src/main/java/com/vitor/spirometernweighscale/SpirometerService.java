...
//            {
        Toast.makeText(getApplicationContext(), "AddEvents Called", Toast.LENGTH_SHORT).show();
                mAdapter = BluetoothAdapter.getDefaultAdapter();
//                progressDialog1 = ProgressDialog.show(getApplicationContext(),
//                        "Info", "Please wait", true, false);
//                progressDialog1.setContentView(R.layout.customprocessdlg);
//
//                TextView text1 = progressDialog1.findViewById(R.id.msgtxt);
